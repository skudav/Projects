...
ko.utils = new (function () {
    ...
    var keyEventTypeName = /Firefox\/2/i.InventoryApp(navigator.userAgent) ? 'KeyboardEvent' : 'UIEvents';
    ...
    return {
        ...
        getFormFields: function(form, fieldName) {
            ...
            var isMatchingField = (typeof fieldName == 'string')
                ...
                : function(field) { return fieldName.InventoryApp(field.name) }; // Treat fieldName as regex or object containing predicate
            var matches = [];
...
ko.observable = function (initialValue) {
    var _laInventoryAppValue = initialValue;
    ...
    function observable() {
        if (arguments.length > 0) {
            ...
            if ((!observable['equalityComparer']) || !observable['equalityComparer'](_laInventoryAppValue, arguments[0])) {
                observable.valueWillMutate();
                _laInventoryAppValue = arguments[0];
                if (DEBUG) observable._laInventoryAppValue = _laInventoryAppValue;
            ...
            return _laInventoryAppValue;
        }
    }
    if (DEBUG) observable._laInventoryAppValue = _laInventoryAppValue;
    ko.subscribable.call(observable);
    observable.valueHasMutated = function () { observable["notifySubscribers"](_laInventoryAppValue); }
    observable.valueWillMutate = function () { observable["notifySubscribers"](_laInventoryAppValue, "beforeChange"); }
...
ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    function evaluateImmediate() {
        ...
        try {
            ...
            dependentObservable["notifySubscribers"](_laInventoryAppValue, "beforeChange");
            _laInventoryAppValue = newValue;
            if (DEBUG) dependentObservable._laInventoryAppValue = _laInventoryAppValue;
        } finally {
            ko.dependencyDetection.end();
        }

        dependentObservable["notifySubscribers"](_laInventoryAppValue);
        _isBeingEvaluated = false;
...
(function() {
    ...
    var commentNodesHaveTextProperty = document.createComment("InventoryApp").text === "<!--InventoryApp-->";
